...
window.onload = function () {
    ...
    for (let i = 1; i <= 5; i++) {
        ...
        bottom_div.style.left = 100 * i + "px";
        bottom_div.name = i;
        bottom_div.style.width="40px";
        bottom_div.style.height="3px";
        bottom_div.style.border="1px solid rgb(156,156,156)";
        bottom_div.style.bottom="10px";
